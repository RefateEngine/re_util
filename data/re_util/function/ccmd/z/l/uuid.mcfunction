...
data modify storage re_util: ccmd.interactionUUID set from entity @s attack.player
...
execute if data storage re_util: ccmd{check:false} run function re_util:ccmd/z/l/run with entity @s data