advancement revoke @s only re_util:click_cmd_l
...
execute as @e[type=interaction,tag=re_util_click_cmd,distance=..10] run function re_util:click_cmd/z/l/timestamp
