...
data modify storage re_util: click_cmd.interactionUUID set from entity @s attack.player
...
execute if data storage re_util: click_cmd{check:false} run function re_util:click_cmd/z/l/run with entity @s data