...
execute store success storage re_util: tickCTRL.4 byte 1 if score #re_util_gametime re_util = #re_util_tc4 re_util run scoreboard players add #re_util_tc2 re_util 4
